...
all: constants.o error_handler.o read_input.o potential.o write_data.o main.o
	${F90} -o constants.o error_handler.o read_input.o potential.o write_data.o main.o -o planetSim
	@rm -f *.o *.mod
